        ...
        <>
            ...
            <section className="relative bg-gradient-to-b from-[#0f172a] via-[#1e3a8a] to-[#3b82f6] text-white py-16 md:py-24 overflow-hidden">
                <div className="absolute inset-0 overflow-hidden">
                    <svg
                        className="absolute left-0 bottom-0 h-full w-full text-white opacity-3"
                        fill="currentColor"
                        viewBox="0 0 100 100"
                    ...
                    <svg
                        className="absolute right-0 top-0 h-full w-full text-white opacity-3"
                        fill="currentColor"
                        viewBox="0 0 100 100"
                        preserveAspectRatio="none"
                    >
                ...
                <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
                    <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight">
                            Join Our <span className="text-sky-200 relative inline-block">
                                Team
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                            <a
                                href="#open-positions"
                                className="px-6 py-3 bg-white text-[#1e3a8a] font-bold rounded-lg hover:bg-sky-50 transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                            >
                                View Open Positions
                            </a>
                        </div>
                ...
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="order-1 lg:order-2 relative">
                            ...
                            <div className="absolute -bottom-4 -right-4 md:-bottom-6 md:-right-6 w-full h-full bg-[#1e40af] rounded-lg transform -rotate-3"></div>
                    ...
                    <div className="mt-16 md:mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="bg-white p-8 rounded-lg text-center transform transition-transform hover:-translate-y-1 hover:shadow-md border-t-4 border-[#3b82f6]">
            ...
            <section id="open-positions" className="py-16 md:py-24 bg-gradient-to-b from-white to-[#dbeafe]">
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="h-1 w-24 bg-[#3b82f6] mx-auto rounded-full mb-8"></div>

                    {/* Enhanced Filter System */}
                    <div className="bg-white rounded-lg shadow-md p-6 mb-8 border border-[#bfdbfe]">
                        ...
                        <div className="mt-4 text-right">
                            <button
                                ...
                                className="text-[#3b82f6] hover:text-[#1e40af] font-medium transition-colors"
                            >
                                Reset Filters
                            </button>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredJobs.map((job) => (
                            <div
                                key={job.id}
                                className="bg-white rounded-lg shadow-md p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1 border-t-4 border-[#3b82f6]"
                            >
                                ...
                                <div className="flex flex-wrap gap-4 text-sm text-[#64748b] mb-4">
                                    <span className="flex items-center">
                                        <svg
                                            className="w-4 h-4 mr-1 text-[#3b82f6]"
                                            fill="none"
                                            stroke="currentColor"
                                            viewBox="0 0 24 24"
                                            xmlns="http://www.w3.org/2000/svg"
            ...
            {showForm && (
                <div className="fixed inset-0 bg-[#0f172a] bg-opacity-70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-bold text-[#0f172a]">
                                    Apply for <span className="text-[#2563eb]">{selectedJob?.title}</span>
                                </h2>
                                <button
            ...
            <section className="py-16 md:py-20 bg-gradient-to-b from-[#0f172a] via-[#1e3a8a] to-[#2563eb] text-white">
                <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <div className="h-1 w-24 bg-[#93c5fd] mx-auto rounded-full mb-6"></div>
                    <p className="text-lg max-w-2xl mx-auto mb-8 text-[#bfdbfe]">
                        Explore our open positions and take the next step in your career
                        journey with us.
                    </p>
                    <a
                        href="#open-positions"
                        className="inline-flex items-center px-6 py-3 bg-white text-[#1e3a8a] font-bold rounded-lg hover:bg-[#f1f5f9] transition-all shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                    >
